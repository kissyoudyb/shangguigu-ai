...
"""
nohup python -u train_unsloth.py >20250818_1.log 2>&1 &
"""
...
model.save_pretrained("/root/outputs/Qwen3-8B-sft-lora-adapter-unsloth")
tokenizer.save_pretrained("/root/outputs/Qwen3-8B-sft-lora-adapter-unsloth")
